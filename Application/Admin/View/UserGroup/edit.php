                    ...
                    <div class="ibox-content">
                        <form action="__ACTION__/group_id/{$msg['id']}"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="title" value="{$msg['title']}" placeholder="" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="introduce" placeholder="" class="form-control" style="height:100px;">{$msg['introduce']}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">收益比例-用户</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="fee_user" value="{$msg.fee_user}" placeholder="" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="fee_service" value="{$msg.fee_service}" placeholder="" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="fee_plantform" value="{$msg.fee_plantform}" placeholder="" >
