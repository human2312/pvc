									...
									<tr>
										...
										<td>
											<if condition='$a[status] eq 1'>
												<button type="button" class="btn btn-primary btn-sm" onclick="changestatus({$a.uid},0);">正常</button>
											<else/>
												<button type="button" class="btn btn-danger btn-sm" onclick="changestatus({$a.uid},1);">禁用</button>
											</if>
										</td>
										<td>{$a['email']}</td>
										<td>{$a['phone']}</td>
