			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：淘宝管理系统 &raquo; 淘宝商品分类管理 &raquo; 编辑淘宝商品分类<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form action="__ACTION__/taobao_cat_id/{$msg['taobao_cat_id']}"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">淘宝官方分类ID</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tb_cat_id" value="{$msg.tb_cat_id}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    if($msg['icon']){
                                        ...
                                        <button class="btn btn-primary" type="button" onclick="deloldimg('.$msg['taobao_cat_id'].')">删除原图标</button>';
                                    }else {
                                        echo '暂无';
                                    } ?>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i>&nbsp;编辑淘宝商品分类</button>
