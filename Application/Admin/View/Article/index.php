			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<a class="btn btn-primary pull-right" href="__CONTROLLER__/add/cat_id/{$cat_id}">添加文章</a>
						<div class="">
									...
									<tr>
										...
										<td>
											<if condition='$a[is_show] eq Y'>
               									<button type="button" class="btn btn-primary btn-sm" onclick="changeshow({$a.article_id},'N');">显示</button>
											<else/>
			   									<button type="button" class="btn btn-danger btn-sm" onclick="changeshow({$a.article_id},'Y');">隐藏</button>
											</if>
										</td>
										<td>
											<if condition='$a.is_top eq Y'>
		       									<button type="button" class="btn btn-danger btn-sm" onclick="changetop({$a.article_id},'N');">置顶</button>
											<else/>
												<button type="button" class="btn btn-primary btn-sm" onclick="changetop({$a.article_id},'Y');">不置顶</button>
											</if>
										</td>
										<td>{$a['clicknum']}</td>
										<td>{$a['pubtime']}</td>
