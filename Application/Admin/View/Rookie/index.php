			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<a class="btn btn-primary pull-right" href="__CONTROLLER__/add">添加活动</a>
						<div class="ibox">
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="__CONTROLLER__/reward?id={$value.id}">奖励设置</a></td>
										<td><a href="/dmooo.php/RookieRecord/index?id={$value.id}">兑现记录</a></td>
										<td>
