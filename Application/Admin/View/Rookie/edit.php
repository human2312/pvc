                    ...
                    <div class="ibox-content">
                        <form action="__ACTION__/id/{$id}"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" value="{$data.name}" placeholder="必填，请输入活动名称" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">活动时段</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control layer-date" name="start_time" value="{$data.start_time}" placeholder="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"> -
                                    <input type="text" class="form-control layer-date" name="end_time" value="{$data.end_time}" placeholder="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">兑现时段</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control layer-date" name="exs_time" value="{$data.exs_time}" placeholder="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"> -
                                    <input type="text" class="form-control layer-date" name="exe_time" value="{$data.exe_time}" placeholder="" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">等级个数</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="lv_num" value="{$data.lv_num}" placeholder="必填，请输入等级个数" >
                                </div>
                            </div>
                            <div class="form-group">
