			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：牧场管理 &raquo; 成交中心<i class="fa fa-angle-double-right"></i></a></h3>
					</div>
	                                ...
	                                <foreach name="list" item="l">
                            	      <tr>
                                          ...
                                          <td>
                                              <?php
                                              if($l['timg']) {
                                                  echo '<img src="'.@$l['timg'].'" height="50px" onclick="lookimg(this.src)">';
                                              }
                                              ?>
                                          </td>
                                          <td>
                                          ...
                                          <td>
                                              ...
                                              if($l['status'] == 2 || $l['status'] == 4 ) {
                                                  echo ' <a href="__MODULE__/Muchang/jiaoyiedit/id/'.$l['id'].'">审核通过</a>';
                                              }
                                              ?>
