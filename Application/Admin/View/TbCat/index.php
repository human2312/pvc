			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
                        <form action="__ACTION__" method="get" role="form" class="form-inline pull-left" style="width: 400px">
                        	淘宝官方商品分类名称：<input type="text" placeholder="" name="category_name" class="form-control">
                            <button class="btn btn-primary" type="submit">查询</button>
                        </form>
                        <a class="btn btn-primary pull-right" href="__CONTROLLER__/add">添加淘宝官方商品分类</a>
						<div class="">
