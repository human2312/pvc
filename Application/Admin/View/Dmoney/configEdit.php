        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3>当前位置：营销中心 &raquo; 积分抽奖管理<a class="pull-right" href="__CONTROLLER__/configList">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="ibox-content">
                        <form action="__ACTION__/id/{$id}"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="url"  value="{$data.url}" placeholder="" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">提币手续费</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="fee"  value="{$data.fee}" placeholder="" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">最小提币量</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="min"  value="{$data.min}" placeholder="" >
                                </div>
                            </div>
                            <div class="form-group">
