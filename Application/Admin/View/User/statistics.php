				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="ibox">
                              ...
                              <h3>返利总收益：<strong style="color: red">￥{$amount}</strong>（淘宝、拼多多、京东返利收益总和）</h3>
                              <h3>本月返利总额：<strong style="color: red">￥{$amount_month}</strong>（本月淘宝、拼多多、京东返利收益总和）</h3>
                              <h3>用户可提现总额：<strong style="color: red">￥{$amount2}</strong>（会员总余额-本月淘宝、拼多多、京东返利收益总和）</h3>
