			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：订单管理 &raquo; 处理已发货订单<a class="pull-right" href="__CONTROLLER__/send">返回已发货订单 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="status">
                                    	<option value="3" <?php if($msg['status']=='3'){echo 'selected';}?> >已发货</option>
                                    	<option value="4" <?php if($msg['status']=='4'){echo 'selected';}?> >已确认收货</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
