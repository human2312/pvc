		...
		<div class="rt_content">
			<section>
				...
				<form action="__ACTION__" method="get" style="float: left">
					...
					开始时间：
					<input type="text" name="begin_time" value="" onClick="WdatePicker()" class="textbox Wdate" style="width: 90px">
					结束时间：
					<input type="text" name="end_time" value="" onClick="WdatePicker()" class="textbox Wdate" style="width: 90px; margin-right: 10px">
