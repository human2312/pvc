			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：订单管理 &raquo; 审核申请退款订单<a class="pull-right" href="__CONTROLLER__/refund">返回申请退款订单列表 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
      				...
      				<div class="tab-content">
      					...
      					<div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="drawback_refuse_reason" placeholder="" class="form-control" style="height:80px;"></textarea> 
                                </div>
                            </div>
                        </div>
                        <!-- 订单基本信息  -->
