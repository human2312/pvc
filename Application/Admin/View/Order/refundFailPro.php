			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：订单管理 &raquo; 拒绝退款订单<a class="pull-right" href="__CONTROLLER__/refundFail">返回拒绝退款订单列表 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
      				...
      				<div class="tab-content">
      					...
      					<div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="" value="已确认收货" placeholder="" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="" value="{$msg.refund_time}" disabled> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">申请退款理由</label>
                                <div class="col-sm-10">
                                    <textarea name="" placeholder="" class="form-control" style="height:80px;">{$msg['drawback_reason']}</textarea> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">申请退款凭证图片</label>
                                <div class="col-sm-10">
                                    <!--imgContainer-->
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">拒绝退款时间</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="refund_fail_time" value="{$msg.refund_fail_time}" disabled> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">拒绝退款理由</label>
                                <div class="col-sm-10">
                                    <textarea name="drawback_refuse_reason" placeholder="" class="form-control" style="height:80px;">{$msg.drawback_refuse_reason}</textarea> 
                                </div>
                            </div>
                        </div>
                        <!-- 订单基本信息  -->
