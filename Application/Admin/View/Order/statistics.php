  ...
  <div class="right">
    ...
    <div class="right_t">
		...
		根据时间查询订单统计：<select name="createtime">
		  ...
		  开始时间：<input type="text" name="begin_time" value="" onClick="WdatePicker()" class="Wdate input1" style="width:90px">
		  结束时间：<input type="text" name="end_time" value="" onClick="WdatePicker()" class="Wdate input1" style="width:90px;margin-right:10px">
