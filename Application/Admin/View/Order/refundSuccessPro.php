			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h3>当前位置：订单管理 &raquo; 退款成功订单<a class="pull-right" href="__CONTROLLER__/refundSuccess">返回退款成功订单列表 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
				</div>
			</div>
			<div class="row">
      				...
      				<div class="tab-content">
      					...
      					<div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="refund_success_time" value="{$msg.refund_success_time}" disabled> 
                                </div>
                            </div>
                        </div>
                        <!-- 订单基本信息  -->
